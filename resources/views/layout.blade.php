...
<html lang="en">
    <head>
        ...
        <script src="/script/reserve-calendar.js"></script>
        <script src="/script/search-calendar.js"></script>
            ...
            <div class="nav-container mx-auto px-2 sm:px-6 lg:px-8">
              <div class="relative flex h-16 items-center justify-between">
                <div class="absolute inset-y-0 left-0 flex items-center lg:hidden">
                  <!-- Mobile menu button-->
                  <button id="open-mobile-menu" type="button" class="relative inline-flex items-center justify-center rounded-md p-2 text-gray-400 hover:bg-gray-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white" aria-controls="mobile-menu" aria-expanded="false">
                ...
                <div class="flex flex-1 items-center justify-center lg:items-stretch lg:justify-start">
                  ...
                  <div class="hidden lg:ml-8 lg:block">
                    <div class="flex space-x-4">
                      ...
                      <a href="/advanced-search" class="nav-btn text-gray-700 rounded-md px-3 py-2 text-sm font-medium">
                ...
                <div class="absolute inset-y-0 right-0 flex items-center pr-2 lg:static lg:inset-auto lg:ml-6 lg:pr-0">
                  <div class="hidden lg:ml-6 lg:block">
                    <div class="flex space-x-4">
                      ...
                      <a href="/cars/manage" class="text-gray-700 nav-btn rounded-md px-3 py-2 text-sm font-medium">Manage cars</a>
                      <a href="/reservations/manage" class="text-gray-700 nav-btn rounded-md px-3 py-2 text-sm font-medium">Manage reservations
                        @if ($notification)
                ...
                <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                  <div class="hidden sm:ml-6 sm:block">
                    <div class="flex space-x-4">
                      <a href="/login" class="text-gray-700 nav-btn rounded-md px-3 py-2 text-sm font-medium">Log in</a>
                    </div>
                  </div>
                </div>
                @endauth
                <div id="dropdown-wrapper" class="relative inline-block text-left">
                  <div>
                  ...
                  <div id="dropdown" class="hidden absolute right-0 z-10 mt-2 w-auto origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
                    <div class="py-1" role="none">
                      @switch($currency)
                          @case('PLN')
                              <a href="setcurrency/USD" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="menu-item-1">🇺🇸 USD</a>
                              <a href="setcurrency/EUR" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="menu-item-2">🇪🇺 EUR</a>  
                              @break
                          @case('USD')
                              <a href="setcurrency/PLN" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="menu-item-0">🇵🇱 PLN</a>
                              <a href="setcurrency/EUR" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="menu-item-2">🇪🇺 EUR</a>  
                              @break
                          @case('EUR')
                              <a href="setcurrency/PLN" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="menu-item-0">🇵🇱 PLN</a>
            ...
            <div class="hidden lg:hidden" id="mobile-menu">
              <div class="space-y-1 px-2 pb-3 pt-2">
                @auth
                  ...
                  <a href="/cars/manage" class="text-gray-900 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium">Manage cars</a>
                  <a href="/reservations/manage" class="text-gray-900 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium">Manage reservations
                    @if ($notification)
                      <span class="notification-badge relative top-0.5 right-1 px-[3px] py-0 rounded-full bg-red-600 inline-block h-2.5"> &nbsp;</span>
                    @endif
                  </a>
                  <a href="/advanced-search" class="text-gray-900 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium">Advanced search</a>
                  <form class="inline" method="POST" action="/logout">
                  @csrf
                ...
                @else
                  <a href="/advanced-search" class="text-gray-900 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium">Advanced search</a>
                  <a href="/login" class="text-gray-900 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium">Log in</a>
                @endauth
              </div>
            </div>
          </nav>
    ...
    <footer class="absolute gap-1.5 sm:gap-7 bottom-0 left-0 w-full flex items-center font-bold bg-white text-gray-600 h-20 mt-24 opacity-90 justify-center sm:flex-row flex-col">
        <p class="sm:ml-2">Copyright &copy; RentOrLend 2024</p>
