...
<div class="bg-gray-50 border border-gray-200 p-10 rounded max-w-lg mx-auto mt-24">
                    <header class="text-center">
                        ...
                        <p class="mb-4">List your car for rent</p>
                    </header>
                    ...
                    <form method="POST" action="store" enctype="multipart/form-data">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" class="border border-gray-200 rounded p-2 w-full" name="make" placeholder="Eg. Toyota, BMW, Volvo" value="{{ old('car-make') }}" />
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" class="border border-gray-200 rounded p-2 w-full" name="model" value="{{ old('model') }}" />
                            @error('model')
                                <p class="text-red-500">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <input type="number" class="border border-gray-200 rounded p-2 w-full" name="production_year" value="{{ old('production_year') }}" min="1999" max="2024" placeholder="Example: 2014" />
                        ...
                        <div class="mb-6">
                            ...
                            <input type="number" class="border border-gray-200 rounded p-2 w-full" name="mileage" value="{{ old('mileage') }}" min="0" max="999999" step="1000" placeholder="Example: 118000" />
                            @error('production_year')
                                <p class="text-red-500">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <input type="number" class="border border-gray-200 rounded p-2 w-full" name="fuel_usage" value="{{ old('fuel_usage') }}" min="0" max="30" placeholder="Example: 7.5" />
                            @error('fuel_usage')
                                <p class="text-red-500">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <input type="number" class="border border-gray-200 rounded p-2 w-full" name="price" value="{{ old('price') }}" min="0" placeholder="Example: 40" />
                            @error('price')
                                <p class="text-red-500">{{ $message }}</p>
                            @enderror
                        </div>
